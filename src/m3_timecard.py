...
def main():
    ...
    hoursm = get_hours(day_of_week = "Monday")
    hourstu = get_hours(day_of_week = "Tuesday")
    hoursw = get_hours(day_of_week = "Wednesday")
    hourst = get_hours(day_of_week = "Thursday")
    hoursf = get_hours(day_of_week = "Friday")
